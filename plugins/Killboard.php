...
//	private $kbDB = null;
	...
	public function enqueueStyle() {
		if(\preg_match('/development/', \APPLICATION_ENV)) {
			\wp_enqueue_style('yulai-federation-killboard', \get_stylesheet_directory_uri() . '/plugins/css/killboard-widget.css');
		} else {
			\wp_enqueue_style('yulai-federation-killboard', \get_stylesheet_directory_uri() . '/plugins/css/killboard-widget.min.css');
