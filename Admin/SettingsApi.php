...
class SettingsApi {
    ...
    public function get() {
        if(!empty($this->args['get'])) {
            $item_array = \call_user_func_array([$this, 'get' . YulaiFederation\Helper\StringHelper::getInstance()->camelCase($this->args['get']), true], [$this->args]);
...
//        $callback_base = \admin_url() . $screen->parent_file;
                        ...
                        <div class="upload" data-field-id="<?php echo $args['field_id']; ?>"<?php echo $upload_status; ?>>
                            <span class="button upload-button">
                                <a href="#">
                                    ...
                                    <?php echo \__('Upload', 'yulai-federation'); ?>
                                </a>
                            </span>
                        </div>
                        <div class="image">
                        ...
                        <div class="remove"<?php echo $remove_status; ?>>
                            <span class="button upload-button">
                                <a href="#">
                                    ...
                                    <?php echo \__('Remove', 'yulai-federation'); ?>
                                </a>
                            </span>
                        </div>
    ...
    public function enqueueScripts() {
        if($this->isSettingsPage() === true) {
            ...
            \wp_enqueue_script(
                'settings-api', (\preg_match('/development/', \APPLICATION_ENV)) ? \get_template_directory_uri() . '/Admin/js/settings-api.js' : \get_template_directory_uri() . '/Admin/js/settings-api.min.js'
            );
        }
    }
    ...
    public function enqueueStyles() {
        if($this->isSettingsPage() === true) {
            ...
            \wp_enqueue_style(
                'font-awesome', (\preg_match('/development/', \APPLICATION_ENV)) ? \get_template_directory_uri() . '/font-awesome/css/font-awesome.css' : \get_template_directory_uri() . '/font-awesome/css/font-awesome.min.css'
            );
            \wp_enqueue_style(
                'settings-api', (\preg_match('/development/', \APPLICATION_ENV)) ? \get_template_directory_uri() . '/Admin/css/settings-api.css' : \get_template_directory_uri() . '/Admin/css/settings-api.min.css'
            );
        }
    }
