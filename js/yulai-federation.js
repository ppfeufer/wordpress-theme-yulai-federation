...
//		console.log($(this).attr('src').match(/^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\??v?=?)‌​)([^#\&\?]*).*/));
//		console.log($(this).attr('src').match(/^.*(?:(?:youtu\.be\/|v\/|vi\/|u\/\w\/|embed\/)|(?:(?:watch)?\?v(?:i)?=|\&v(?:i)?=))([^#\&\?]*).*/));
	 ...
	 * @returns {yulai-federation_L21.setModalMaxHeight}
	 */
