...
\spl_autoload_register('\WordPress\Themes\YulaiFederation\autoload');

function autoload($className) {
    // If the specified $className does not include our namespace, duck out.
    if(\strpos($className, 'WordPress\Themes\YulaiFederation') === false) {
        return;
    }
 ...
 */
\spl_autoload_register('\WordPress\Themes\YulaiFederation\autoloadEsiClient');
