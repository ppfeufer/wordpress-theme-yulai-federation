...
class CommentHelper {
	...
	public static function getTrackbackTemplate() {
		...
		$returnValue .= '<p>' . \__('Pingback:', 'yulai-federation') . ' ' . \get_comment_author_link() . '</p>';
	...
	public static function getCommentModerated($comment) {
		...
		if('0' === $comment->comment_approved) {
			$returnValue = '<p class="comment-awaiting-moderation">' . \__('Your comment is awaiting moderation.', 'yulai-federation') . '</p>';
